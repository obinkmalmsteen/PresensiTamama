...
<div class="row">
            ...
            <div class="col-8">
                <div class="form-group">
                    <select name="bulan" id="bulan" class="form-control selectmaterialize" >
                        ...
                        @for ($i = 1; $i <= 12; $i++) <option {{ Request('bulan')== $i ? 'selected':''}} value="{{ $i }}">{{ $namabulan[$i] }} </option>
                        @endfor
                    </select>
                 </div>
             </div>
    ...
    <div class="row mt-2" 
    <div class="row" style="position: fixed; width:100%; margin:auto; overflow-y:scroll; height:530px">
