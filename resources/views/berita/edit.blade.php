<form action="/berita/{{$berita->kode_berita}}/update" method="POST" id="frmeditberita" enctype="multipart/form-data" >
    @csrf
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" id="kode_berita" value="{{$berita->kode_berita}}" name="kode_berita" class="form-control" placeholder="Kode Berita" readonly>
              </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" maxlength="10"  id="tanggal_berita" value="{{ $berita->tanggal_berita }}" name="tanggal_berita" class="form-control" placeholder="Tanggal Libur " autocomplete="off">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" id="nama_berita" value="{{$berita->nama_berita}}" class="form-control" name="nama_berita" placeholder="Nama berita">
              </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" id="isi_berita" value="{{$berita->isi_berita}}" class="form-control" name="isi_berita" placeholder="Isi Berita">
              </div>
        </div>
    </div>
    ...
    <div class="row mt-2">
        <div class="col-12"> 
                ...
                <input type="hidden" name="old_foto" value="{{$berita->gambar}}">
        </div>
    </div>
