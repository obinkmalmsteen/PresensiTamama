 ...
 <aside class="navbar navbar-vertical navbar-expand-lg" data-bs-theme="light">
     <div class="container-fluid">
         ...
         <h1 class="navbar-brand navbar-brand">
             <a href=".">
                 <img src="{{ asset('tabler/static/logorax.png') }}" width="110" height="32" alt="Tabler"
         ...
         <div class="collapse navbar-collapse" id="sidebar-menu">
             <ul class="navbar-nav pt-lg-3">
                 ...
                 <li class="nav-item dropdown">
                     <a class="nav-link dropdown-toggle {{ request()->is(['presensi/monitoring']) ? 'show' : '' }}"
                         href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button"
                         aria-expanded="{{ request()->is(['presensi/monitoring']) ? 'true' : '' }}">
                         <span
                             class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/package -->
                             <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                 viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                     ...
                     <div class="dropdown-menu {{ request()->is(['presensi/monitoring']) ? 'show' : '' }}">
                         <div class="dropdown-menu-columns">
                             <div class="dropdown-menu-column">
                                 ...
                                 <a class="dropdown-item {{ request()->is(['presensi/personalmonitoringindex']) ? 'active' : '' }}"
                                    href="/presensi/personalmonitoringindex">
                                    Personal
                                </a>
                             </div>
                         </div>
                 ...
                 <li class="nav-item dropdown">
                     <a class="nav-link dropdown-toggle {{ request()->is(['presensi/izinsakit']) ? 'show' : '' }}"
                         href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button"
                         aria-expanded="{{ request()->is(['presensi/izinsakit']) ? 'true' : '' }}">
                         <span
                             class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/package -->
                     ...
                     <div class="dropdown-menu {{ request()->is(['presensi/izinsakit']) ? 'show' : '' }}">
                         <div class="dropdown-menu-columns">
                             <div class="dropdown-menu-column">
                                 <a class="dropdown-item {{ request()->is(['presensi/izinsakit']) ? 'active' : '' }}"
                 ...
                 {{-- @role('administrator', 'user')
                 <li class="nav-item dropdown">
                     <a class="nav-link dropdown-toggle {{ request()->is(['gajian','gajian/getgajikaryawan']) ? 'show' : '' }}"
                         href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button"
                         aria-expanded="{{ request()->is(['karyawan', 'departemen']) ? 'true' : '' }}">
                         <span
                             class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/package -->
                     ...
                     <div class="dropdown-menu {{ request()->is(['gajian','gajian/getgajikaryawan','kasbon/indexkasbon','kasbon/indexhariankasbon']) ? 'show' : '' }}" >
                      <div class="dropdown-menu-columns">
                         <div class="dropdown-menu-column">
                            
                            <a class="dropdown-item {{ request()->is(['kasbon/indexhariankasbon']) ? 'active' : '' }}" 
                                href="/kasbon/indexhariankasbon">
                                    Data Kasbon Harian
                            </a>
                            <a class="dropdown-item {{ request()->is(['kasbon/indexkasbon']) ? 'active' : '' }}" 
                                href="/kasbon/indexkasbon">
                                    Data Pinjaman Karyawan
                            </a>
                            <a class="dropdown-item {{ request()->is(['gajian/getgajikaryawan']) ? 'active' : '' }}"
                                href="/gajian/getgajikaryawan">
                                Data Gaji Karyawan
                            </a>
                            <a class="dropdown-item {{ request()->is(['gajian'])  ? 'active' : '' }}"
                                href="/gajian">
                                     Proses Gajian
                            </a>
                         </div>
         ...
         @role('administrator', 'user')
                     <li class="nav-item dropdown">
                         <a class="nav-link dropdown-toggle {{ request()->is(['berita', 'konfigurasi/jamkerja','konfigurasi/jamkerjadept','konfigurasi/harilibur','konfigurasi/users']) ? 'show' : '' }}"
                             href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button"
                         ...
                         <div
                             class="dropdown-menu {{ request()->is(['berita', 'konfigurasi/jamkerja','konfigurasi/jamkerjadept','konfigurasi/harilibur','konfigurasi/hariminggu','konfigurasi/users']) ? 'show' : '' }}">
                             <div class="dropdown-menu-columns">
                                 <div class="dropdown-menu-column">
                       ...
                       Koordinat Kantor
                                     ...
                                     <a class="dropdown-item {{ request()->is(['konfigurasi/hariminggu']) ? 'active' : '' }}"
                                        href="/konfigurasi/hariminggu">
                                        Hari Minggu
                                    </a>
