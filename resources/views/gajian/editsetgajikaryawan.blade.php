    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" id="nik" value="{{$gajian->nik}}" name="nik" class="form-control" placeholder="NIK" readonly>
              </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" id="tgl_gajian" value="{{$gajian->tgl_gajian}}" class="form-control" name="tgl_gajian" placeholder="Tanggal Gajian">
              </div>
        </div>
    </div>
